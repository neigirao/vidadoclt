...
const CORPUS = [
  ...
  "inovacao disruptiva",
  "lean thinking agil",
  "culture fit organizacional",
  "gestao de stakeholders",
  "quick win de alto impacto",
  "low hanging fruit de resultado",
  "mover o ponteiro do indicador",
  "vestir a camisa da empresa",
  "proatividade e ownership",
  "empoderamento de equipe",
  "onboarding do processo novo",
  "offboarding humanizado",
  "feedback construtivo e urgente",
  "reuniao de alinhamento rapido",
  "daily de acompanhamento",
  "sprint de entregaveis prioritarios",
  "roadmap de evolucao continua",
  "okr de crescimento exponencial",
  "kpi de eficiencia operacional",
  "benchmark de mercado competitivo",
  "pivotagem de estrategia agil",
  "scale up de operacoes",
  "cultura de alta performance",
  "engajamento do colaborador",
  "jornada do cliente interno",
  "transformacao digital integrada",
];
