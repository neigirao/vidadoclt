...
export const WEAPONS: Record<WeaponId, WeaponDef> = {
  grampeador: {
    ...
    rangedDamage: 0,
    rangedSpeed: 0,
    rangedPiercing: false,
    rangedBounce: 0,
    rangedHoming: false,
    hitAutoRanged: false,
    specialName: "Rajada de Grampos",
  ...
  grampeador_eletrico: {
    ...
    rangedHoming: false,
    hitAutoRanged: true,
    specialName: "Raio em Cadeia",
    specialCooldown: 8000,
    specialType: "chain_lightning",
    shopCost: 0,
  },
};
...
export const CLASSES: Record<ClassId, ClassDef> = {
  ...
  analista: {
    ...
    description: "Brawler equilibrado.\nGrampeador + combo de 4:\nencadeie o corpo-a-corpo.",
    maxEnergy: 100,
    maxSanity: 100,
    speedMult: 1.0,
    damageMult: 1.0,
