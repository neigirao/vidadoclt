...
export class Phase5Scene extends Phaser.Scene {
  ...
  create() {
    ...
    this.buildPlatform(820, FLOOR_Y - 120, 6);
    this.buildPlatform(1120, FLOOR_Y - 180, 5);
    this.buildPlatform(1400, FLOOR_Y - 120, 6);
    this.buildPlatform(1700, FLOOR_Y - 170, 4);
  ...
  private resolveAttack(hb: Phaser.Geom.Rectangle, step: number) {
    ...
    const damage = Math.round((def.hitDamages[dmgIndex] || def.hitDamages[0]) * this.player.damageMult);
